...
yyreduce:
  ...
  switch (yyn)
    {
        case 4:
#line 26 "complejo_calc.y"
    { imprimirC((yyvsp[(2) - (3)])); }
    break;

  case 5:
#line 28 "complejo_calc.y"
    { (yyval) = (yyvsp[(1) - (1)]);  }
    break;

  case 6:
#line 29 "complejo_calc.y"
    { (yyval) = Complejo_add((yyvsp[(1) - (3)]),(yyvsp[(3) - (3)]));  }
    break;

  case 7:
#line 30 "complejo_calc.y"
    { (yyval) = Complejo_sub((yyvsp[(1) - (3)]),(yyvsp[(3) - (3)]));  }
    break;

  case 8:
#line 31 "complejo_calc.y"
    { (yyval) = Complejo_mul((yyvsp[(1) - (3)]),(yyvsp[(3) - (3)]));  }
    break;

  case 9:
#line 32 "complejo_calc.y"
    { (yyval) = Complejo_div((yyvsp[(1) - (3)]),(yyvsp[(3) - (3)]));  }
    break;

  case 10:
#line 33 "complejo_calc.y"
    { (yyval) = (yyvsp[(2) - (3)]);}
    break;
